...
var score = 0;
var maxhealth = "<?php echo $_POST['hp']; ?>";
var maxpower = "<?php echo $_POST['str']; ?>";
...
function endGame() {
  ...
  context.fillText('Game Over. Final Score: ' + score, canvas.width / 2, canvas.height / 2);
	...
	setTimeout(function(){location.replace("https://web.njit.edu/~pk398/IT-202/Project/home.php"); }, 5000);
}
...
function draw() {
  ...
  context.fillText('HP: ' + maxhealth, 1, 50)
  context.fillText('STR: ' + maxpower, 1, 75)
